...
# # loop.run_forever()
#
# nc.register_callback(Frame.FRAME_TYPES['measurment'], lambda frame: print(frame.data))
#
# nc.on_message(Frame(Frame.FRAME_TYPES['measurment'], b"hello world", 10, 11).serialize())

message = Frame(Frame.FRAME_TYPES['measurment'], b"hello world", 10, 11).serialize() + b'f'
